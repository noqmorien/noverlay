...
XANMOD_RELD="20251205"
XANMOD_RELF="ge9b99b1"
...
SRC_URI_X64V2="https://downloads.sourceforge.net/xanmod/releases/edge/${PV}-xanmod1/${PV}-${XANMOD_REL_V2}/linux-image-${PV}-${XANMOD_REL_V2}_${PV}-${XANMOD_REL_V2}-0~${XANMOD_RELD}.${XANMOD_RELF}_amd64.deb"
SRC_URI_X64V3="https://downloads.sourceforge.net/xanmod/releases/edge/${PV}-xanmod1/${PV}-${XANMOD_REL_V3}/linux-image-${PV}-${XANMOD_REL_V3}_${PV}-${XANMOD_REL_V3}-0~${XANMOD_RELD}.${XANMOD_RELF}_amd64.deb"
